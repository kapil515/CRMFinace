...
export default function NotificationSettings() {
    ...
    return (
        <div className="space-y-10 pb-5">
            <h3 className="text-[22px] font-inter font-medium text-[#878787] mb-9.5 p-5 border-b border-[#878787]">Partner Management</h3>

            <div className="px-5">
                {/* General Notifications */}
                <div className="flex items-center justify-between py-5 border-b border-[#C1C7CD] mb-5">
                    <div>
                        <p className="text-base font-medium text-[#525256] font-inter">John Doe</p>
                        <p className="text-base font-normal text-[#999DA3] font-inter border border-[rgba(159, 159, 159, 0.20)] py-1.5 px-4 rounded-[8] min-w-[210px] mt-4">johndoe@gmail.com</p>
                    </div>
                    <button
